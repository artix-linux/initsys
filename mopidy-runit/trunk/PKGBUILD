...
pkgname=mopidy-runit
pkgver=20200803
pkgrel=3
pkgdesc="Runit service script for mopidy"
arch=('any')
...
depends=('mopidy' 'runit')
groups=('runit-galaxy')
provides=('init-mopidy')
conflicts=('init-mopidy')
source=("mopidy.run")
sha256sums=('429b0530140da15fdfc4bcc0c37abb38409dfdd4240b03a0a3d24ca900caaf59')
