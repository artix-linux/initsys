...
pkgname=prosody-runit
pkgver=20200704
pkgrel=2
pkgdesc="runit service scripts for prosody"
arch=('any')
...
groups=('runit-galaxy')
depends=('prosody' 'runit')
provides=('init-prosody')
conflicts=('init-prosody')
source=("prosody.run")
sha256sums=('e87a6c69896f00bc73b312c6bbc9c926ad44f313252d6e138ae7d70ddb697c40')
